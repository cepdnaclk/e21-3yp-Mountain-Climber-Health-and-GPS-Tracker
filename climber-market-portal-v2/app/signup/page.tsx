          ...
          <form onSubmit={handleSignup} className="auth-form">
            ...
            <div className="form-group">
              ...
              <input
                ...
                className="form-input"
              />
              <span className="text-xs text-secondary mt-1 block">Format: name@domain.com</span>
            </div>
            ...
            <div className="form-group">
              ...
              <input
                ...
                className="form-input"
              />
              <span className="text-xs text-secondary mt-1 block">Minimum 6 characters</span>
            </div>
